    ...
    public class ConsignmentRepository : IConsignmentRepository
    {
        ...
        public async Task<List<DropDownListModel>> GetLRSeriesForBill()
        {
            ...
            try
            {
                ...
                {
                    SqlParameter[] param = { };
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(dbconnection.Value.DBConnection, "GetLRSeriesForBill_Select", param);
        ...
        public async Task<ResponseModel> ConsignmentSave(ConsignmentModel ConsignmentModel)
        {
            ...
            try
            {
                if (dbconnection != null)
                {
                    SqlParameter[] param =
                        {
                            ...
                            new SqlParameter("@AttachLRtoSameTrip ", ConsignmentModel.AttachLRtoSameTrip),
                    ...
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(transaction, "Consignment_Insert", param);
                    ...
                    SqlParameter[] param =
                       {
                           ...
                           new SqlParameter("@LoadOrEmpty", request.LoadOrEmpty)
                        };
