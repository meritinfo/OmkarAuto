                    ...
                    SqlParameter[] param =
                        {
                            ...
                            new SqlParameter("@LoggedInUser", destinationMasterModel.LoggedInUserID)
                        };
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(transaction, "usp_DestinationDetailsSave", param);
