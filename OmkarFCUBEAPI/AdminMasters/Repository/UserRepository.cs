                    ...
                    SqlParameter[] param =
                        {
                            ...
                            new SqlParameter("@EnableLastNewTripDate", userMasterModel.EnableLastNewTripDate),
                            new SqlParameter("@EnableFromTo", userMasterModel.EnableFromTo),
                            new SqlParameter("@EnableDriver", userMasterModel.EnableDriver),
                            new SqlParameter("@CanCancalBill", userMasterModel.CanCancelBill),
                            new SqlParameter("@AttachLRtoSameTrip", userMasterModel.AttachLRtoSameTrip),
                    ...
                    if (dataSet != null && dataSet.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dataSet.Tables[0].Rows.Count; i++)
                        {
                            userList.Add(new UserMasterModel
                            {
                                ...
                                EnableLastNewTripDate = Convert.ToString(dataSet.Tables[0].Rows[i]["EnableLastNewTripDate"]),
                                EnableFromTo    = Convert.ToString(dataSet.Tables[0].Rows[i]["EnableFromTo"]),
                                EnableDriver    = Convert.ToString(dataSet.Tables[0].Rows[i]["EnableDriver"]),
                                CanCancelBill   = Convert.ToString(dataSet.Tables[0].Rows[i]["CanCancelBill"]),
                                AttachLRtoSameTrip= Convert.ToString(dataSet.Tables[0].Rows[i]["AttachLRtoSameTrip"]),
