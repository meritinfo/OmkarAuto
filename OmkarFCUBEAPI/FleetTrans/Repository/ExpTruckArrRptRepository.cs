...
namespace FleetTrans.Repository
{
    public class ExpTruckArrRptRepository : IExpTruckArrRptRepository
    {
        ...
        //                R1.MergeCells = true;
        //                R1.HorizontalAlignment = Excel.Constants.xlCenter;
        ...
        //                R2.MergeCells = true;
        //                R2.HorizontalAlignment = Excel.Constants.xlRight;
        ...
        //                R3.MergeCells = true;
        //                R3.HorizontalAlignment = Excel.Constants.xlCenter;
        ...
        //                R4.MergeCells = true;
        //                R4.HorizontalAlignment = Excel.Constants.xlCenter;
        ...
        //                R5.HorizontalAlignment = Excel.Constants.xlCenter;
        ...
        //                        Excel.Range R6 = Worksheets.get_Range(Worksheets.Cells[v + 6, 1], Worksheets.Cells[v + 6, 10]);
        //                        R6.MergeCells = true;
        //                        R6.Font.Bold = true;
        //                        Worksheets.Cells[v + 6, 1] = Expdt;
        //                    }

        //                    Worksheets.Cells[v + 6, 1] = v + 1;
        //                    Worksheets.Cells[v + 6, 2] = dataSet.Tables[0].Rows[v]["LoadingDate"].ToString();
        //                    Worksheets.Cells[v + 6, 3] = dataSet.Tables[0].Rows[v]["VehicleNo"].ToString();
        //                    Worksheets.Cells[v + 6, 4] = dataSet.Tables[0].Rows[v]["LoadingBranch"].ToString();
        //                    Worksheets.Cells[v + 6, 5] = dataSet.Tables[0].Rows[v]["LoadingFrom"].ToString();
        //                    Worksheets.Cells[v + 6, 6] = dataSet.Tables[0].Rows[v]["Destination"].ToString();
        //                    Worksheets.Cells[v + 6, 7] = dataSet.Tables[0].Rows[v]["MatLoadType"].ToString();
        //                    Worksheets.Cells[v + 6, 8] = dataSet.Tables[0].Rows[v]["PartyName"].ToString();
        //                    Worksheets.Cells[v + 6, 9] = dataSet.Tables[0].Rows[v]["DriverName"].ToString();
        //                    Worksheets.Cells[v + 6, 10] = dataSet.Tables[0].Rows[v]["DriverPhone"].ToString();
        //                    v++;
        //                }
        //                Excel.Range RA6 = Worksheets.get_Range(Worksheets.Cells[6, 1], Worksheets.Cells[v + 6, 1]);

        //                RA6.HorizontalAlignment = Excel.Constants.xlRight;
