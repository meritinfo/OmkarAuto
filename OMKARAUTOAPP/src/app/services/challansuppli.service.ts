...
export class ChallansuppliService {
  httpOptions = {
  ...
  challanDetailsSubmitted(challanmaster: Challanmastermodel): Observable<Responsemodel> {
    return this.httpClient.post<Responsemodel>(Constants.API_ENDPOINT + 'Consignment/ChallanSuppliSave', challanmaster, this.httpOptions);
  }
  getChallanList(filter: Reportmodel): Observable<Challanlistmodel> {
    return this.httpClient.post<Challanlistmodel>(Constants.API_ENDPOINT + 'Consignment/GetChallanSuppliList', filter, this.httpOptions);
  }  
  challanDelete(req: Requestmodel): Observable<Responsemodel> {
    return this.httpClient.post<Responsemodel>(Constants.API_ENDPOINT + 'Consignment/ChallanSuppliDelete', req, this.httpOptions);
  }  
  checkDuplicateChallan(req: Requestmodel): Observable<Responsemodel> {
    return this.httpClient.post<Responsemodel>(Constants.API_ENDPOINT + 'Consignment/CheckDuplicateChallanSuppli', req, this.httpOptions);
  }  
}
