...
@Component({
  selector: 'app-tripmasterllplist',
  templateUrl: './tripmasterllplist.component.html',
  styleUrls: ['./tripmasterllplist.component.css']
})
export class TripmasterllplistComponent {
