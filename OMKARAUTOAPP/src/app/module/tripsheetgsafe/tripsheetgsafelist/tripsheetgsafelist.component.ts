...
@Component({
  selector: 'app-tripsheetgsafelist',
  templateUrl: './tripsheetgsafelist.component.html',
  styleUrls: ['./tripsheetgsafelist.component.css']
})
export class TripsheetgsafelistComponent {
  ...
  tripsheetAdd(): void {
    this.route.navigate(['/tripsheetgsafeadd']);
  }
  ...
  gettripSheetDetails(tripsheet: Tripmastermodel): void {
    ...
    this.route.navigate(['/tripsheetgsafeedit']);
  }
