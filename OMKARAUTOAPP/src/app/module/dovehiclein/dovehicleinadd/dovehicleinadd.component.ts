...
dashboard: string ="";
  ...
  submitDoVehiInDetails(): void {
    ...
    this.dovehicleinmodel.truckNo         = selectedDataVal.truckNo.toString().toUpperCase();         
    this.dovehicleinmodel.ownMarket       = selectedDataVal.ownMarket?selectedDataVal.ownMarket:"M";
    ...
    this.dovehicleinmodel.chasisNo        = selectedDataVal.chasisNo.toString().toUpperCase();      
    this.dovehicleinmodel.engineNo        = selectedDataVal.engineNo.toString().toUpperCase();     
    ...
    this.dovehicleinmodel.panNo           = selectedDataVal.panNo.toString().toUpperCase();   
    ...
    this.dovehicleinmodel.driverName      = selectedDataVal.driverName?selectedDataVal.driverName.toString().toUpperCase():"";   
    this.dovehicleinmodel.driverAddress   = selectedDataVal.driverAddress?selectedDataVal.driverAddress.toString().toUpperCase():"";
    this.dovehicleinmodel.driverMobile1   = selectedDataVal.driverMobile1?selectedDataVal.driverMobile1.toString():""  ;   
    this.dovehicleinmodel.driverMobile2   = selectedDataVal.driverMobile2?selectedDataVal.driverMobile2.toString():""  ; 
    this.dovehicleinmodel.driverLicense   = selectedDataVal.driverLicense?selectedDataVal.driverLicense.toString().toUpperCase():"";   
    this.dovehicleinmodel.driverLicValid  = selectedDataVal.driverLicValid?selectedDataVal.driverLicValid.toString():"";   
