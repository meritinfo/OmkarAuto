...
@Component({
  selector: 'app-vehicleprofitlossstatementrpt',
  templateUrl: './vehicleprofitlossstatementrpt.component.html',
  styleUrls: ['./vehicleprofitlossstatementrpt.component.css']
})
export class VehicleprofitlossstatementrptComponent {
  ...
  ngOnInit(): void {     
    ...
    if (typeof menuData !== 'undefined' && menuData !== null && menuData !== '') {
      ...
      .find((aa: { menuName: string; }) => aa.menuName === "Vehicle P/L Statement");
      if (privilegeStatus) {
  ...
  exportExcel(): void {      
    ...
    this.fleetreportsService.getVehiclePLStatementRptExcel(this.filter).subscribe(resp => {      
      if(resp.status){      
        ...
        link.download = "VehicleProfitLossReport" + "_" + new Date().getTime() + '.xlsx';
