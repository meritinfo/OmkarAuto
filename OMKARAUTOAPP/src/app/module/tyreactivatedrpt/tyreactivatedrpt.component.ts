...
@Component({
  selector: 'app-tyreactivatedrpt',
  templateUrl: './tyreactivatedrpt.component.html',
  styleUrls: ['./tyreactivatedrpt.component.css']
})
export class TyreactivatedrptComponent {
...
dashboard: string =""; 
  ...
  ngOnInit(): void {   
    ...
    var privilegeStatus = menuTypeList.flatMap((item: { menuList: any; }) => item.menuList)
      .find((aa: { menuName: string; }) => aa.menuName === "Tyre Activation Report");
      if (privilegeStatus) {
  ...
  getTyreStatus(){
    this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.tyremgntrptService.getTyreActivatedRptList(this.filter).subscribe(resp => {
  ...
  exportExcel(): void {      
    ...
    this.tyremgntrptService.getTyreActivatedRptExcel(this.filter).subscribe(resp => {
      if(resp.status){      
        let link = document.createElement("a");
        link.download = "TyreActivated" + "_" + new Date().getTime() + '.xlsx';
