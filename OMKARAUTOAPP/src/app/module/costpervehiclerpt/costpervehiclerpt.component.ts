...
@Component({
  selector: 'app-costpervehiclerpt',
  templateUrl: './costpervehiclerpt.component.html',
  styleUrls: ['./costpervehiclerpt.component.css']
})
export class CostpervehiclerptComponent {
  ...
  constructor(
    private fleetreportsService: FleetreportsService, 
  ...
  ngOnInit(): void {     
    ...
    if (typeof menuData !== 'undefined' && menuData !== null && menuData !== '') {
      ...
      .find((aa: { menuName: string; }) => aa.menuName === "Cost Per Vehicle");
      if (privilegeStatus) {
  ...
  exportExcel(): void {      
    ...
    this.fleetreportsService.getCostPerVehicleRptExcel(this.filter).subscribe(resp => {
      if(resp.status){      
        let link = document.createElement("a");
        link.download = "Cost Per Vehicle" + "_" + new Date().getTime() + '.xlsx';
