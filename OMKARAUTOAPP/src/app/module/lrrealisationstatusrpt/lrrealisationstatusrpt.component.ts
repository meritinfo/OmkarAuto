...
@Component({
  selector: 'app-lrrealisationstatusrpt',
  templateUrl: './lrrealisationstatusrpt.component.html',
  styleUrls: ['./lrrealisationstatusrpt.component.css']
})
export class LrrealisationstatusrptComponent {
  ...
  constructor(private lrwithoutchallanrptService: FreightreportsService, 
  ...
  exportExcel(): void {      
    ...
    this.lrwithoutchallanrptService.getLrRealisationStatusExcel(this.filter).subscribe(resp => {
      if(resp.status){        
        let link = document.createElement("a");
        link.download = "LrRealisationStatusReport" + new Date().getTime() + '.xlsx'; 
