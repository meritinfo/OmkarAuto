        ...
        public async Task<ResponseModel> FleetCardMasterSave(FleetCardMasterModel fleetCardMasterModel)
        {
            ...
            try
            {
                if (dbconnection != null)
                {
                    ...
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(transaction, "FleetCardMasterMaster_Insert", param);
        ...
        public async Task<ResponseModel> FleetCardMasterDelete(RequestModel req)
        {
            ...
            try
            {
                if (dbconnection != null)
                {
                    ...
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(transaction, "usp_FleetCardMasterDelete", param);
        ...
        public async Task<ResponseModel> CheckDuplicateCardNo(CardModel request)
        {
            ...
            try
            {
                if (dbconnection != null)
                {
                    ...
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(dbconnection.Value.DBConnection, "sp_CheckDuplicateCardNo", param);
        ...
        public async Task<ResponseModel> CheckDuplicateCardCode(CardModel request)
        {
            ...
            try
            {
                if (dbconnection != null)
                {
                    ...
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(dbconnection.Value.DBConnection, "sp_CheckDuplicateCardCode", param);
