...
{
    public class BeneficiaryMasterModel
    {
        public string? MasterId { get; set; }
        public string? BenType { get; set; }
        public string? BenCode { get; set; }
        public string? BenName { get; set; }
        public string? BenCoAcName { get; set; }
        public string? BenAdd1 { get; set; }
        public string? BenAdd2 { get; set; }
        public string? BenAdd3  { get; set; }
