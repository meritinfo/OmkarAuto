...
namespace FCUBEAPI.Controllers
{
    ...
    public class FleetTransController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTransTypeValidations(RequestModel request)
        {
            ...
            try
            {
                var result = await tripPaymentsBusiness.GetTransTypeValidations(request);
        ...
        [HttpPost("GetVehicleInstAmount")]
        public async Task<IActionResult> GetVehicleInstAmount(RequestModel req)
        {
            if (req == null)
            {
                return BadRequest("Invalid request data");
            ...
            try
            {
                var result = await vehicleInstPmtBusiness.GetVehicleInstAmount(req);
        ...
        [HttpPost("GetVehicleLastTransDateRptExcel")]
        public async Task<IActionResult> GetVehicleLastTransDateRptExcel(ReportRequestModel request)
        {
            if (request == null)
            {
                return BadRequest("Invalid request data");
            ...
            try
            {
                var result = await fleetRptBusiness.GetVehicleLastTransDateRptExcel(request);
