...
namespace FCUBEAPI.Controllers
{
    ...
    public class FreightMastersController : ControllerBase
    {
        ...
        [HttpPost("GetBillLnTPdf")]
        public async Task<IActionResult> GetBillLnTPdf(ReportRequestModel request)
        {
            if (request == null)
            {
                return BadRequest("Invalid request data");
            ...
            try
            {
                var result = await billsMasterBusiness.GetBillLnTPdf(request);
        ...
        [HttpPost("GetOutstandingDetailLRRptExcel")]
        public async Task<IActionResult> GetOutstandingDetailLRRptExcel(ReportAgeModel request)
        {
            if (request == null)
            {
                return BadRequest("Invalid request data");
            ...
            try
            {
                var result = await freightRptBusiness.GetOutstandingDetailLRRptExcel(request);
