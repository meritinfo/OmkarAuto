...
namespace FCUBEAPI.Controllers
{
    ...
    public class FinanceMastersController : ControllerBase
    {
        ...
        [HttpPost("FinAccountGstLocDelete")]
        public async Task<IActionResult> FinAccountGstLocDelete(RequestModel request)
        {
            if (request == null)
            {
                return BadRequest("Invalid request data");
            ...
            try
            {
                var result = await finAccountsMasterBusiness.FinAccountGstLocDelete(request);
        ...
        [HttpPost("OpeningBalUpdate")]
        public async Task<IActionResult> OpeningBalUpdate(RequestModel req)
        {
            if (req == null)
            {
                return BadRequest("Invalid request data");
            ...
            try
            {
                var result = await openingBalanceMasterBusiness.OpeningBalUpdate(req);
        ...
        [HttpPost("CheckDuplicateBenName")]
        public async Task<IActionResult> CheckDuplicateBenName(RequestModel req)
        {
            if (req == null)
            {
                return BadRequest("Invalid request data");
            ...
            try
            {
                var result = await beneficiaryMasterBusiness.CheckDuplicateBenName(req);
