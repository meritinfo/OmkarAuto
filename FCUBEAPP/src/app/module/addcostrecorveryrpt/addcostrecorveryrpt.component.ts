...
@Component({
  selector: 'app-addcostrecorveryrpt',
  templateUrl: './addcostrecorveryrpt.component.html',
  styleUrls: ['./addcostrecorveryrpt.component.css']
})
export class AddcostrecorveryrptComponent {
  ...
  allAddcostrecorveryrptlist: Addcostrecorveryrptlistmodel = new Addcostrecorveryrptlistmodel();
  filter: Reportmodel = {
    pageNumber: 1,
    pageSize: 10,
  ...
  constructor(private addcostrecorveryrptService: AddcostrecorveryrptService, 
    ...
    ngOnInit(): void {     
      ...
      if (typeof menuData !== 'undefined' && menuData !== null && menuData !== '') {
        ...
        .find((aa: { menuName: string; }) => aa.menuName === "Addtional Cost/Rec Report");
        if (privilegeStatus) {
    ...
    addcostrecorveryList(){
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.addcostrecorveryrptService.getAddcostrecorveryrptList(this.filter).subscribe(resp => {
            this.allAddcostrecorveryrptlist = resp; 
              callback({
    ...
    //  this.filter.filterStr3  = selectedDataVal.destination?selectedDataVal.destination.dataId:"";
      this.addcostrecorveryrptService.getAddcostrecorveryrptExcel(this.filter).subscribe(resp => {
