...
@Component({
  selector: 'app-trippaymentsllplist',
  templateUrl: './trippaymentsllplist.component.html',
  styleUrls: ['./trippaymentsllplist.component.css']
})
export class TrippaymentsllplistComponent {
  ...
  trippaymentsAdd(): void {
    this.route.navigate(['/trippaymentllpadd']);
  }
  ...
  gettrippaymentsDetails(trippayments: Trippaymentsmodel): void {
    ...
    this.route.navigate(['/trippaymentllpedit']);
  }
