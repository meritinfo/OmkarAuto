...
@Component({
  selector: 'app-tyredeactivatedrpt',
  templateUrl: './tyredeactivatedrpt.component.html',
  styleUrls: ['./tyredeactivatedrpt.component.css']
})
export class TyredeactivatedrptComponent {
  ...
  ngOnInit(): void {   
    ...
    var privilegeStatus = menuTypeList.flatMap((item: { menuList: any; }) => item.menuList)
      .find((aa: { menuName: string; }) => aa.menuName === "Tyre DeActivation Report");
      if (privilegeStatus) {
  ...
  getTyreStatus(){
    this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.tyremgntrptService.getTyreDeActivatedRptList(this.filter).subscribe(resp => {
  ...
  exportExcel(): void {      
    ...
    this.tyremgntrptService.getTyreDeActivatedRptExcel(this.filter).subscribe(resp => {
      if(resp.status){      
        let link = document.createElement("a");
        link.download = "TyreDeActivated" + "_" + new Date().getTime() + '.xlsx';
