...
@Component({
  selector: 'app-tripmarginsummaryrpt',
  templateUrl: './tripmarginsummaryrpt.component.html',
  styleUrls: ['./tripmarginsummaryrpt.component.css']
})

export class TripmarginsummaryrptComponent {
  ...
  constructor(private tripSummaryRptService: FleetreportsService, 
  ...
  ngOnInit(): void {
    ...
    if (typeof menuData !== 'undefined' && menuData !== null && menuData !== '') {
      ...
      var privilegeStatus = menuTypeList.flatMap((item: { menuList: any; }) => item.menuList)
        .find((aa: { menuName: string; }) => aa.menuName === "Trip Margin Summary");
      if (privilegeStatus) {
