...
@Component({
  selector: 'app-challansuppliadd',
  templateUrl: './challansuppliadd.component.html',
  styleUrls: ['./challansuppliadd.component.css']
})
export class ChallansuppliaddComponent {
  formUser!: FormGroup;
  ...
  constructor(private route: Router, private formBuilder: FormBuilder,
    private challanmodel: Challanmastermodel, private challanmasterService: ChallansuppliService,
