...
@Component({
  selector: 'app-trippaymentsbrpllist',
  templateUrl: './trippaymentsbrpllist.component.html',
  styleUrls: ['./trippaymentsbrpllist.component.css']
})
export class TrippaymentsbrpllistComponent {
  ...
  trippaymentsAdd(): void {
    this.route.navigate(['/trippaymentlistbrpladd']);
  }
  ...
  gettrippaymentsDetails(trippayments: Trippaymentsmodel): void {
    ...
    this.route.navigate(['/trippaymentlistbrpledit']);
  }
