...
@Component({
  ...
  templateUrl: './consignmentllplist.component.html',
  styleUrls: ['./consignmentllplist.component.css']
})
export class ConsignmentllplistComponent {
  ...
  consignmentAdd(): void { 
    ...
    this.route.navigate(['/consignmentllpadd']);
  }
  ...
  getConsignmentDetails(Consignment: Consignmentmodel): void { 
    ...
    this.route.navigate(['/consignmentllpedit']);
  }
