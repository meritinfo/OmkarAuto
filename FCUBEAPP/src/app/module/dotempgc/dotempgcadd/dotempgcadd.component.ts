...
@Component({
  selector: 'app-dotempgcadd',
  templateUrl: './dotempgcadd.component.html',
  styleUrls: ['./dotempgcadd.component.css']
})
export class DotempgcaddComponent {
  ...
  selectedTempgcDetails = new Dotempgcmodel();

  constructor(private route: Router, private formBuilder: FormBuilder, 
    private tempgcmodel: Dotempgcmodel,
    private ratesMasterService: RatesMasterService,
    private toasterService: ToastrService,private requestmodel:Requestmodel,
    private generatetempgcService: DotempgcService, private sharedService: SharedService,
    private commonService: CommonService) {
    this.selectedTempgcDetails = new Dotempgcmodel();
  }
  ...
  ngOnInit(): void {    
    ...
    this.formUser.controls['vehOwnerName'].disable(); 
    this.formUser.controls['vehOwnerMobile'].disable(); 
      ...
      if (confirm("Are you sure, you want to delete this?")) {   
        ...
        this.generatetempgcService.tempgcDelete(this.requestmodel).subscribe((res: Responsemodel) => {
          ...
          if(this.responseDetails.status){
            ...
            this.formUser.reset();
            this.route.navigate(['/dotempgclist']);
          }
          else{
  ...
  submittempgcDetails(): void {
    ...
    this.tempgcmodel.doId      = this.selectedTempgcDetails.doId? this.selectedTempgcDetails.doId :"";
    ...
    this.generatetempgcService.tempgcSubmitted(this.tempgcmodel).subscribe((res: Responsemodel) => {
      this.responseDetails = res;
      if(this.responseDetails.status){
        this.toasterService.success(this.responseDetails.message);
        this.formUser.reset();
