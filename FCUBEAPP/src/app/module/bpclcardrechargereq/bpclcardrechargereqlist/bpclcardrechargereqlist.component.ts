...
@Component({
  selector: 'app-bpclcardrechargereqlist',
  templateUrl: './bpclcardrechargereqlist.component.html',
  styleUrls: ['./bpclcardrechargereqlist.component.css']
})
export class BpclcardrechargereqlistComponent {
  createStatus = false;
  editStatus = false;
  deleteStatus = false;
  viewStatus = false; 
  ...
  constructor(private rechargerequestService: RechargerequestService,private formBuilder: FormBuilder,
