...
@Component({
  selector: 'app-lorryhirepmtllpadd',
  templateUrl: './lorryhirepmtllpadd.component.html',
  styleUrls: ['./lorryhirepmtllpadd.component.css']
})
export class LorryhirepmtllpaddComponent {
 onAcBranchShow=true;
