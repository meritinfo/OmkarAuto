...
@Component({
  selector: 'app-missingdocrpt',
  templateUrl: './missingdocrpt.component.html',
  styleUrls: ['./missingdocrpt.component.css']
})
export class MissingdocrptComponent {
  ...
  allDocRptlist: Documentallotmentlistmodel = new Documentallotmentlistmodel();
  filter: Reportmodel = {
    pageNumber: 1,
    pageSize: 10,
  ...
  constructor(private docRenewalRptService: FreightreportsService, 
