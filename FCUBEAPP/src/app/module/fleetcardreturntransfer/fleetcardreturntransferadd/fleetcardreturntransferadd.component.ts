...
@Component({
  selector: 'app-fleetcardreturntransferadd',
  templateUrl: './fleetcardreturntransferadd.component.html',
  styleUrls: ['./fleetcardreturntransferadd.component.css']
})
export class FleetcardreturntransferaddComponent {
 branchList      : Dropdownmodel[] = [];
  ...
  constructor(
    ...
    private fleetcardreturntransfermodel: Fleetcardreturntransfermodel,
    ...
    ngOnInit(): void {
      ...
      if (typeof menuData !== 'undefined' && menuData !== null && menuData !== '') {
        ...
        .find((( aa: { menuName: string; }) => aa.menuName === "Fleet Card Amount Return"));      
        if (privilegeStatus) {
  ...
  exit(): void {
    this.route.navigate(['/fleetcardamtrtrn']);
  } 
