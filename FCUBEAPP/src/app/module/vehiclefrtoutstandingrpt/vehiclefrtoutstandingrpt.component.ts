...
@Component({
  selector: 'app-vehiclefrtoutstandingrpt',
  templateUrl: './vehiclefrtoutstandingrpt.component.html',
  styleUrls: ['./vehiclefrtoutstandingrpt.component.css']
})
export class VehiclefrtoutstandingrptComponent {
...
dashboard: string =""; 
 ...
 // locationList: Dropdownmodel[] = [];
  ...
  allVehiclefrtoutstandingrptlist: Vehiclefrtoutstandingrptlistmodel = new Vehiclefrtoutstandingrptlistmodel();
  filter: Reportmodel = {
    pageNumber: 1,
    pageSize: 10,
  ...
  constructor(private vehiclefrtoutstandingrptService: FleetreportsService, 
    ...
    ngOnInit(): void {     
      ...
      if (typeof menuData !== 'undefined' && menuData !== null && menuData !== '') {
        ...
        .find((aa: { menuName: string; }) => aa.menuName === "Vehicle Freight Outstanding Report");
        if (privilegeStatus) {
  ...
  endWithFilter = function (List: Dropdownmodel[], query: string): any[] {
    ...
    vehiclefrtoutstandingrptlist(){
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.vehiclefrtoutstandingrptService.getVehiclefrtoutstandingrptList(this.filter).subscribe(resp => {
    ...
    //  this.filter.filterStr  = selectedDataVal.origin?selectedDataVal.origin.dataId:"";
      ...
      this.vehiclefrtoutstandingrptService.getVehiclefrtoutstandingrptExcel(this.filter).subscribe(resp => {
