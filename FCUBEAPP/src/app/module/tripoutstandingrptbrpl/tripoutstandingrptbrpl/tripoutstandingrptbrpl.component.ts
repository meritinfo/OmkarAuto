...
import { Tripoutstandingrptlistbrplmodel  } from 'src/app/models/tripoutstandingrptlistbrplmodel';
...
@Component({
  selector: 'app-tripoutstandingrptbrpl',
  templateUrl: './tripoutstandingrptbrpl.component.html',
  styleUrls: ['./tripoutstandingrptbrpl.component.css']
})
export class TripoutstandingrptbrplComponent {
  ...
  dashboard: string =""; 
    ...
    allTripOutstandingRptlist: Tripoutstandingrptlistbrplmodel = new Tripoutstandingrptlistbrplmodel();
    filter: Reportmodel = {
      pageNumber: 1,
      pageSize: 10,
...
formFilter!: FormGroup;
  ...
  endWithFilter = function (List: Dropdownmodel[], query: string): any[] {
      ...
      this.dtOptions = {
        ...
        language: {
          ...
          ajax: (dataTablesParameters: any, callback) => {
            ...
            this.tripOutstandingRptService.getTripOutstandingRptListBrpl(this.filter).subscribe(resp => {
    ...
    exportExcel(): void {      
      ...
      this.tripOutstandingRptService.getTripOutstandingRptListExcelBrpl(this.filter).subscribe(resp => {
        if(resp.status){      
