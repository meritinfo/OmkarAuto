...
import { ChallanregisterrptService } from 'src/app/services/challanregisterrpt.service';
...
export class ChallanregisterrptComponent {
  ...
  constructor(private challanregisterrptService: ChallanregisterrptService, 
