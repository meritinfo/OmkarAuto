...
dashboard: string ="";
  ...
  minDate: string = '';
  year: string = '';
  constructor(private tyresalesService: TyresalesService,private toasterService: ToastrService,
  ...
  tyresaleList() {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.tyresalesService.getTyresalesMasterList(this.filter).subscribe(resp => {
