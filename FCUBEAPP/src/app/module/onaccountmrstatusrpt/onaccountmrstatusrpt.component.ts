...
@Component({
  selector: 'app-onaccountmrstatusrpt',
  templateUrl: './onaccountmrstatusrpt.component.html',
  styleUrls: ['./onaccountmrstatusrpt.component.css']
})
export class OnaccountmrstatusrptComponent {
...
dashboard: string =""; 
  ...
  allOnaccountmrstatusrptlist: Onaccountmrstatusrptlistmodel = new Onaccountmrstatusrptlistmodel();
  filter: Reportmodel = {
    pageNumber: 1,
    pageSize: 10,
  ...
  constructor(private onaccountmrstatusrptService: FreightreportsService, 
    ...
    ngOnInit(): void {     
      ...
      if (typeof menuData !== 'undefined' && menuData !== null && menuData !== '') {
        ...
        .find((aa: { menuName: string; }) => aa.menuName === "On A/c MR Status Report");
        if (privilegeStatus) {
    ...
    onaccountmrstatusList(){
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.onaccountmrstatusrptService.getOnaccountmrstatusrptList(this.filter).subscribe(resp => {
            this.allOnaccountmrstatusrptlist = resp; 
              callback({
    ...
    //  this.filter.filterStr3  = selectedDataVal.destination?selectedDataVal.destination.dataId:"";
      this.onaccountmrstatusrptService.getOnaccountmrstatusrptExcel(this.filter).subscribe(resp => {
