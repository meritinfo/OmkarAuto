...
@Component({
  selector: 'app-dovehiplacededit',
  templateUrl: './dovehiplacededit.component.html',
  styleUrls: ['./dovehiplacededit.component.css']
})
export class DovehiplacededitComponent {
  ...
  ngOnInit(): void {
    ...
    this.selectedDoDetails = this.doentryService.getDoVehiDetails();
  ...
  deleteDprDetailsForm(): void {
    if(this.selectedDoDetails.doVpId != '' ){   
      this.requestmodel.strRequest = this.selectedDoDetails.doVpId
      if (confirm("Are you sure, you want to delete this?")) {   
        this.sharedService.loading=true;
        this.doentryService.doVehiPlacedDelete(this.requestmodel).subscribe((res: Responsemodel) => {
  ...
  submitDprDetails(): void {
    ...
    this.dovehiplacedmodel.doVpId = this.selectedDoDetails.doVpId;  
