...
@Component({
  selector: 'app-billsmasterlistllp',
  templateUrl: './billsmasterlistllp.component.html',
  styleUrls: ['./billsmasterlistllp.component.css']
})
export class BillsmasterlistllpComponent {
  ...
  billsMasterAdd(): void {
    this.route.navigate(['/billsmasteraddllp']);
  }
