...
import { Creditnoteentrylistmodel } from 'src/app/models/creditnoteentrylist';
...
@Component({
  selector: 'app-creditnoteentrylist',
  templateUrl: './creditnoteentrylist.component.html',
...
ngOnInit(): void {   
    ...
    this.creditNoteService.clearCreditDetails();
  ...
  getCreditList(){
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.creditNoteService.getCreditNoteList(this.filter).subscribe(resp => {
           this.allCredit = resp;
            callback({
