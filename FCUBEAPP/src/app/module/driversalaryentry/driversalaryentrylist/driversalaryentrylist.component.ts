...
@Component({
  selector: 'app-driversalaryentrylist',
  templateUrl: './driversalaryentrylist.component.html',
  styleUrls: ['./driversalaryentrylist.component.css']
})
export class DriversalaryentrylistComponent {
  createStatus = false;
    editStatus = false;
    deleteStatus = false;
    viewStatus = false; 
  dashboard: string ="";
    ...
    alldriver: Driversalaryentrylistmodel = new Driversalaryentrylistmodel();
    filter: Reportmodel = {
      pageNumber: 1,
      pageSize: 10,
...
constructor(private driversalaryentryService: DriverSalaryEntryService, 
  ...
  ngOnInit(): void {    
    ...
    this.fromDate = this.minDate ;
      ...
      this.driversalaryentryService.clearDriverSalaryEntryDetails();
    ...
    driversalaryentrylist(){
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.sharedService.loading = true;
        this.driversalaryentryService.getDriverSalaryEntryList(this.filter).subscribe(resp => {
           this.alldriver = resp;
            callback({
    ...
    driversalaryentryadd(): void {
      this.route.navigate(['/driversalaryentryadd']);
    }
    ...
    getdriversalaryentryDetails(finact: Driversalaryentrymodel): void {
      this.driversalaryentryService.setDriverSalaryDetails(finact);
      this.route.navigate(['/driversalaryentryedit']);
    }
