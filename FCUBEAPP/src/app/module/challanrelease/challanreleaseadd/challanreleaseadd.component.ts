...
export class ChallanreleaseaddComponent {
  ...
  constructor(private route: Router, private formBuilder: FormBuilder, private challanreleaseModel: ChallanreleaseModel,  private toasterService: ToastrService,private challanReleaseService: ChallanReleaseService,private requestmodel:Requestmodel,private reportmodel:Reportmodel, private commonService: CommonService) {
...
//     this.challanReleaseService.checkDuplicateBrand(this.requestmodel).subscribe((res: Responsemodel) => {
...
submitChallanReleaseForm(): void {
  ...
  this.challanreleaseModel.chReleaseId = this.selectedChallanReleaseDetails.chReleaseId != '' ? this.selectedChallanReleaseDetails.chReleaseId : '';
  this.challanreleaseModel.chYear= this.formUser.value.chYear.toString().toUpperCase();
 // this.challanreleaseModel.challanBranch = this.formUser.value.brandType;
