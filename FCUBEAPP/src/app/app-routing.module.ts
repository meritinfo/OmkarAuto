...
const routes: Routes = [
 ...
 // { path: 'ratesmasterlist', component: RatesmasterlistComponent },
  ...
  { path: 'onacmrstratus', component: OnaccountmrstatusrptComponent },  
  { path: 'mrreg', component: MrregisterrptComponent },
  ...
  { path: 'dashboardbrpl', component:  DashboardbrplComponent },  
