...
export class CommonService {
  ...
  getServerDate(req: Requestmodel): Observable<Responsemodel> {
    return this.httpClient.post<Responsemodel>(Constants.API_ENDPOINT + 'Login/GetServerDate', req, this.httpOptions);
  }
  ...
  getBrokerListLLP(): Observable<Dropdownmodel[]> {
    return this.httpClient.post<Dropdownmodel[]>(Constants.API_ENDPOINT + 'Consignment/GetBrokerListLLP', null, this.httpOptions);
  }  
  ...
  getLedgerList(): Observable<Dropdownmodel[]> {
    return this.httpClient.post<Dropdownmodel[]>(Constants.API_ENDPOINT + 'FreightMasters/GetLedgerList', null, this.httpOptions);
  }  
  ...
  getTransTypeList(): Observable<Dropdownmodel[]> {
    return this.httpClient.post<Dropdownmodel[]>(Constants.API_ENDPOINT + 'Consignment/GetTransTypeList', null, this.httpOptions);
  }
