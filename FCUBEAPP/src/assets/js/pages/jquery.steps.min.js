    ...
    var $ = a.fn.steps.contentMode = {
        ...
        cb = a.fn.steps.defaults = {
            ...
            onStepChanging: function () {
                a.find('a[href="#finish"]')[0].style.display = 'none';
                return !0
            },
            onStepChanged: function () {
                var btn = a.find(':submit');
                var prev = a.find('a[href="#previous"]');
                if (currentIndex != 2) {
                    jQuery(prev).removeAttr("class", "");
                    jQuery(btn).removeAttr("class", "wizardSubmit");
                    btn[0].style.display = "none";
                } else{
                    
                    jQuery(prev).attr("class", "wizardPrevious");
                    jQuery(btn).attr("class", "btn btn-primary w-md wizardSubmit");
                }
            },
            onCanceled: function () { },
