...
{
    public class VehicleAdvBalReceiptMstLLPModel
    {
        ...
        public List<VehicleAdvBalReceiptDtlListLLPmodel>? VehicleAdvBalReceiptDtlList { get; set; }

    }
    public class VehicleAdvBalReceiptDtlListLLPmodel
    {
