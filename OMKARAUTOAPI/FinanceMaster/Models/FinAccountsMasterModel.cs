namespace FinanceMasters.Models
{
    ...
    { 
        ...
        public string? ManualJv { get; set; }
        public string? IsAdminExpYN { get; set; }
        public string? HideBranch { get; set; }
        public string? HideNonAdmin { get; set; }
        public string? TdsLedgerYN { get; set; }
        public string? OnlineActiveYn { get; set; }
        public string? Username { get; set; }
        public string? Password { get; set; }
        public string? SendEmail { get; set; }
        public string? PartyType { get; set; }
        public string? ContractValidity { get; set; }
        public string? StaxEX { get; set; }
