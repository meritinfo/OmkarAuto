    ...
    public class DprVehiPlacedRepository : IDprVehiPlacedRepository
    {
        ...
        public async Task<ResponseModel> ChkVehicleApiDataDprYN()
        {
            ...
            try
            {
                if (dbconnection != null)
                {
                    ...
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(dbconnection.Value.DBConnection, "usp_ChkVehicleApiDataDprYN");
        ...
        public async Task<DprVehiPlacedModel> GetTruckDetails(RequestModel request)
        {
            ...
            try
            {
                ...
                string URL = "http://www.fcube.net/truckno/signzy/api.php";
        ...
        public async Task<ResponseModel> DprVehiPlacedDeleteLr(RequestModel requestModel)
        {
            ResponseModel responseModel = new();
            ...
            try
            {
                if (dbconnection != null)
                {
                    ...
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(transaction, "usp_DprVehiPlacedDeleteLr", param);
            ...
            try
            {
                if (dbconnection != null)
                {
                    SqlParameter[] param =
                        {
                         new SqlParameter("@VehiclePlacedId", requestModel.strRequest),
                            new SqlParameter("@AssignToStaff", requestModel.strRequest1),
                             new SqlParameter("@VehicleEngagedBy", requestModel.strRequest2),
                             
                        };
                    var statusData = await SqlHelper.SqlHelper.ExecuteDatasetAsync(transaction, "usp_UpdateAssignEngaged", param);
