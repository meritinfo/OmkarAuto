...
ngOnInit(): void {
  ...
  this.formCustWizard = this.formBuilder.group({
   ...
   tripMChallanAc: new FormControl('',[Validators.required]),
   tripWeighmentAc: new FormControl('',[Validators.required]),
   tripAccidentAc: new FormControl('',[Validators.required]),
   tripTollAc: new FormControl('',),
   tripOthersMiscAc: new FormControl('',[Validators.required]),
   tripDrAlAc: new FormControl('',[Validators.required]),
   delayDamageAc: new FormControl('',[Validators.required]),
   ...
   fastagTollAc: new FormControl('',[Validators.required]),
   happayAc: new FormControl('',[Validators.required]),
   driverPoolAc: new FormControl('',[Validators.required]),
   driverSalAc: new FormControl('',[Validators.required]),
   frtIncAc: new FormControl('',[Validators.required]),
   tripTravelAlAc: new FormControl('',[Validators.required]),
   tripIncentiveAc: new FormControl('',[Validators.required]),
   tripRecdDrAc: new FormControl('',[Validators.required]),
